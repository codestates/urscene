...
module.exports = {
	signIn: async (req, res) => {
		...
		const refreshToken = jwt.sign({}, process.env.JWT_SECRET, { expiresIn: "14d", issuer: "cotak" })
		...
		try {
			...
			await connection.query(` INSERT INTO tokens(content, user_no) VALUE (?, ?); `, [refreshToken, user_no])
