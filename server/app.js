...
const searchedsingleRouter = require("./routes/searchedsingle.route")
const searchedgalleryRouter = require("./routes/searchedgallery.route")
...
app.use("/searched_singlepost", searchedsingleRouter)
app.use("/searched_gallery", searchedgalleryRouter)
